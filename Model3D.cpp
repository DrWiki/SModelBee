...
void Model3D::model_load(QString path){
...
void Model3D::model_readText(QString path){
    model_clear();
...
void Model3D::model_readBinary(QString path){
    model_clear();
...
modelSize Model3D::model_getSize(){
    return size;
}

void Model3D::model_getSizeWhileReadPoint(QVector3D point){
...
QVector3D Model3D::model_getCenter(modelSize size){
    QVector3D center;
...
int Model3D::model_getFacesCount(){
    return faceList.size();
}

QVector3D Model3D::getCoordinateFromString(QString line){
